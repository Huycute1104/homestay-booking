...
export function HotelRoomCard({ roomData }) {
  const roomStyleName = roomData.roomStyle.roomStyleName;
  const roomImageUrls = roomData.roomImageDTOs.map((image) => image.roomImageUrl);
  ...
  return (
    <Card className="w-full max-w-6xl mx-auto border-none shadow-none mt-2 px-4 sm:px-6 lg:px-8">
